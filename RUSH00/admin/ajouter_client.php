...
include 'core/ajouter_client.php';
...
<div class="form admin_form">
	...
	<form action="ajouter_client.php" method="post">
		<fieldset>
			...
			<?php if(isset($err_enre)) echo "<span class='succ'>Votre compte a été créé avec succès</span>";
 ?>
			<div class="labele">
				...
				<label for="name">Adresse : </label><input type="text" name="address" value="" /> <br>
				<label for="name">Code Postal : </label><input type="text" name="postal_code" value="" /> <br>
